...
class __Mustache_13e1199d1bf96c01726124d090621e00 extends Mustache_Template
{
...
';
        $buffer .= $indent . '        }
';
        $buffer .= $indent . '        .btn-primary{
';
        $buffer .= $indent . '            background-color: var(--primary);
';
        $buffer .= $indent . '            border-color: var(--primary);
';
        $buffer .= $indent . '        }
';
        $buffer .= $indent . '    </style>
