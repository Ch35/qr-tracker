...
class __Mustache_f24c9f3d83c8bf46994128f8e085e716 extends Mustache_Template
{
...
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '    <div id="page" class="container" style="background-image: url(';
        $value = $this->resolveValue($context->findDot('cfg.wwwroot'), $context);
        $buffer .= ($value === null ? '' : htmlspecialchars($value, 2, 'UTF-8'));
        $buffer .= '/img/background.jpeg);">
';
        $buffer .= $indent . '        <div class="text-center mb-5">
';
...
';
        $buffer .= $indent . '    
';
        $buffer .= $indent . '            <span><b>Distribution Centre:</b> HERIOTDALE</span>
';
        $buffer .= $indent . '        </div>
';
        $buffer .= $indent . '
...
';
        $buffer .= $indent . '                <label for="storename" class="form-label">Enter Store Name</label>
';
        $buffer .= $indent . '                <input type="text" class="form-control" id="storename">
';
        $buffer .= $indent . '            </div>
';
